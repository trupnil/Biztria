                	...
                	<div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        <div class="lng_dropdown mr-2">
                            <select name="countries" class="custome_select">
                                <option value='en' data-image="{{url('Users_assets')}}/assets/images/eng.png" data-title="English">Vadodara</option>
    	...
    	<div class="container">
            <nav class="navbar navbar-expand-lg"> 
                <a class="navbar-brand" href="index.html">
                    <img class="logo_light" src="{{url('Users_assets')}}/assets/images/logo_light.png" alt="logo" />
                    <img class="logo_dark" src="{{url('Users_assets')}}/assets/images/logo_dark.png" alt="logo" />
                </a>
