                ...
                <div class="table-responsive wishlist_table">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <td class="product-price" data-title="Price">${{ $value->discount_price }}</td>
                                ...
                                <td class="product-stock-status" data-title="Stock Status"><span class="badge badge-pill badge-success">In Stock</span></td>
                                 ...
                                 @if(!empty($value->product_link))
                                   ...
                                   <td class="product-add-to-cart"><a href="{{$value->product_link}}" target="_blank" class="btn btn-fill-out"><i class="icon-basket-loaded"></i> Buy Now</a></td>

                                   @else

                                     <td class="product-add-to-cart"><a href="javascript:void(0);" class="btn btn-fill-out" onclick="addToCart({{$value->id}},1)"><i class="icon-basket-loaded"></i> Add to cart</a></td>
