                ...
                <div class="table-responsive wishlist_table">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <td class="product-price" data-title="Price">$<?php echo e($value->discount_price); ?></td>
                                ...
                                <td class="product-stock-status" data-title="Stock Status"><span class="badge badge-pill badge-success">In Stock</span></td>
                                 ...
                                 <?php if(!empty($value->product_link)): ?>
                                   ...
                                   <td class="product-add-to-cart"><a href="<?php echo e($value->product_link); ?>" target="_blank" class="btn btn-fill-out"><i class="icon-basket-loaded"></i> Buy Now</a></td>

                                   <?php else: ?>

                                     <td class="product-add-to-cart"><a href="javascript:void(0);" class="btn btn-fill-out" onclick="addToCart(<?php echo e($value->id); ?>,1)"><i class="icon-basket-loaded"></i> Add to cart</a></td>
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\larastore\resources\views/user/wishlists.blade.php ENDPATH**/ ?>