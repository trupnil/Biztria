	                        ...
	                        <div class="white-box">
	                            ...
	                            <div class="row">
	                                <div class="col-md-12">
										<div class="pull-left">
											<address>
												<img src="<?php echo e(url('Users_assets')); ?>/assets/images/logo_dark.png" width="120px" height="42.52px" alt="logo" class="logo-default" />
                            ...
                            <p>Payment Type:<b> <?php if($order->payment == 'cod'): ?>  <?php echo e("Pay On Delivery"); ?><?php elseif($order->payment == 'online'): ?> <?php echo e("Online"); ?>  <?php endif; ?> </b> </p>
	                                ...
	                                <div class="col-md-12">
	                                    <div class="pull-right m-t-30 text-right">
	                                       <hr>
	                                        <h4><b>Grand Total :</b>&#8377;<?php echo e($order->total_amount); ?></h4> </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('Admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\larastore\resources\views/Admin/order_details.blade.php ENDPATH**/ ?>